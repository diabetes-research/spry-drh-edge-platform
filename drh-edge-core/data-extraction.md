...
export PORT=9227
export STUDY_DATA_PATH="raw-datass/dexcom-synthetic-cgm/"
...
## Run Remote Pipeline with Local Environment
...
REMOTE_BASE_URL="https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/"
...
```bash  
spry sp spc --fs dev-src.auto --destroy-first --conf sqlpage/sqlpage.json --md data-extraction.md 
```
...
```bash
spry sp spc --fs dev-src.auto --destroy-first --conf sqlpage/sqlpage.json --watch --with-sqlpage --md data-extraction.md 
```
...
```bash
spry sp spc  --fs dev-src.auto --destroy-first --conf sqlpage/sqlpage.json --watch --md data-extraction.md 
```
...
spry sp spc --package --conf sqlpage/sqlpage.json --md data-extraction.md | sqlite3 resource-surveillance.sqlite.db   
...
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/participant_hidden_input.handlebars . 
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/stacked_bar_chart.handlebars . 
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/agp-chart.handlebars .
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/dgp-chart.handlebars 
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/gri_component.handlebars 
https://raw.githubusercontent.com/diabetes-research/spry-drh-edge-platform/refs/heads/AN/edge-remote-access/drh-edge-core/sqlpage/templates/advanced_metrics.handlebars 
```
