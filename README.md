...
- [DRH Edge Platform: Researcher \& Data Scientist Guide](#drh-edge-platform-researcher--data-scientist-guide)
  ...
  - [Environment \& State Management](#environment--state-management)
    ...
    - [How to set permissions after cloning](#how-to-set-permissions-after-cloning)
...
### How to set permissions after cloning

Navigate to the `drh-edge-core/` directory and run:

```bash
chmod +x reset.sh setup.sh
